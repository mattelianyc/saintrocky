...
const trayTooltipBase = '$TANDARD / DEVIANT$ Desktop Runtime';
let tray = null;
...
ipcMain.handle('desktop-runtime:show-notification', async (_event, payload = {}) => {
  ...
  const notification = new Notification({
    title: payload.title || (runtimeConfig.ELECTRON_APP_NAME || desktopRuntimeModels.branding.productName),
    body: payload.body || '',
