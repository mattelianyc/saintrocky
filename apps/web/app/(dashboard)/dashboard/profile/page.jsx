  ...
  return (
    <>
      <DashboardSectionPage
        ...
        title="Profile"
        description="Update your account identity, keep your dashboard session current, and manage access to $TANDARD / DEVIANT$."
        items={[]}
      />
            ...
            <form className="sr-ProfilePage__form" onSubmit={handleSaveProfile}>
              <label className="sr-ProfilePage__field">
                ...
                <Input
                  ...
                  placeholder="Disciplined operator"
              ...
              <label className="sr-ProfilePage__field">
                ...
                <Input
                  ...
                  placeholder="operator@thestandard.dev"
