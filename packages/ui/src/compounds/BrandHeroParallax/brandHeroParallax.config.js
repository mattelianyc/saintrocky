...
export const REVENUE_MODEL_VALUE_PROPS = [
  ...
  "70% of all override fees are redistributed to traders who stay disciplined."
];
export const REVENUE_MODEL_SIGNOFF = "- Rocco";
...
export const HERO_CHARACTER_EXIT_DURATION = 0.15;
export const HERO_CHARACTER_EXIT_STAGGER = 0.018;
export const HERO_CHARACTER_EXIT_DISTANCE = 1200;
export const HERO_CHARACTER_EXIT_BLUR = 10;
export const HERO_CHARACTER_FADE_RATE_FACTOR = 0.1;
