...
export function RuleTemplatesPanel({ problemIndex = 50, onProblemIndexChange, onRuleCreated, existingRules = [] }) {
  ...
  return (
    <div className="c-RulesWorkspacePanel c-RulesWorkspacePanel--strategy">
      <StatusBanner
        message={message}
      ...
      {status === "loading" ? (
        ...
        <div className="c-RulesWorkspacePanel__strategyGrid">
          <Card className="c-RulesWorkspacePanel__libraryCard">
            <section className="c-RulesWorkspacePanel__stack c-RulesWorkspacePanel__stack--library">
          ...
          <div className="c-RulesWorkspacePanel__detailRail">
            <Card className="c-RulesWorkspacePanel__problemCard">
              <ProblemIndexSlider
                value={problemIndex}
            ...
            <AnimatePresence mode="wait">
              {selectedTemplate ? (
                <motion.section
                  ...
                  className="c-RulesWorkspacePanel__stack"
                  {...CONFIG_REVEAL}
                >
                  <Card className="c-RulesWorkspacePanel__item c-RulesWorkspacePanel__detailCard">
                    <div className="c-RulesWorkspacePanel__itemHeader">
                      ...
                      {isUpdatingExistingRule ? (
                        <span className="c-RulesWorkspacePanel__activeTag">Active</span>
                      ) : null}
                    </div>
                    <p className="c-RulesWorkspacePanel__detailSummary">{selectedTemplate.summary}</p>
